function QS = OFC_CostToGoSpace(S,R,Q)
%% FUNCTION: Outputs cost-to-go of all states in state-space S.
...
% ISSUES:   Incomplete (just computes cost).
% REFS:     Todorov2002*
...
fprintf('OFC_ComputeCostToGoSpace: computing via for-loop...\n');
tic;
for pi1=1:psteps
    for pi2=1:psteps
        for vi1=1:vsteps
...
fprintf('OFC_ComputeCostToGoSpace: '); toc;
